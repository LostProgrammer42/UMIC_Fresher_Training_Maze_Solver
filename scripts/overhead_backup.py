...
class robot_camera():
    ...
    def camera_cb(self, mesaj):
        ...
        for dir in direction:
            ...
            if wall_sum >200 or red_detected:
        ...
        for ele in wall_list:
            ...
            try:
                ...
                continue
        if (len(wall_list) == 3 and len(green_wall_list) == 1 and not in_front) :
            print('Dead End')
            self.red.append(self.demo.pop())
            #if self.dead_end_skip == 0:
                #self.red.append(self.demo.pop())
                #self.dead_end_skip = 1
            #else:
                #self.dead_end_skip -= 1
